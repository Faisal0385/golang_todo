...
func TaskCompletedController(c *gin.Context) {
	var tasks []models.Task
	models.DB.Model(&tasks).Where("status = ?", "completed").Find(&tasks)
	...
	c.HTML(http.StatusOK, "task_completed.html", data)
}
